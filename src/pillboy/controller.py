...
from pillboy.gui.toast import BaseToastOverlayManagerThread
from pillboy.models.settings import Settings
from pillboy.models.singleton import Singleton
from pillboy.models.threads import BaseThread
from pillboy.views.screensaver import ScreensaverScreen
from pillboy.views.view import Destination, View
...
class BackgroundImportThread(BaseThread):
    def run(self):
        ...
        try:
            time_import('numpy')  # used by PiVideoStream; by far the slowest import
            time_import('pillboy.hardware.pivideostream')
        except ImportError:
            # Desktop emulator: no picamera stack available
            pass

        # Get the game picker ready to respond quickly
        time_import('pillboy.games')



class Controller(Singleton):
    """
        The Controller is a globally available singleton that maintains PillBoy state.
    ...
    def configure_instance(cls):
        ...
        from pillboy.hardware.microsd import MicroSD
        ...
        try:
            ...
            while True:
                ...
                if not next_destination:
                    ...
                    from pillboy.views.view import NotYetImplementedView
    ...
    def handle_exception(self, e) -> Destination:
        """
            ...
            Shows:
                ...
                * Exception message
        """
        from pillboy.views.view import UnhandledExceptionView
        logger.exception(e)
    ...
    def is_screensaver_start_allowed(self) -> bool:
        ...
        """
        from pillboy.views import MainMenuView
