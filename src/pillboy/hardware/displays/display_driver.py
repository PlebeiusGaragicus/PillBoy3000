...
class DisplayDriverFactory:
    ...
    def instantiate_display_driver(cls, display_type: str = DISPLAY_TYPE__ST7789, width: int = None, height: int = None) -> BaseDisplayDriver:
        ...
        if not is_raspberry_pi():
            # Desktop emulation: same canvas size, rendered into a tkinter window
            from pillboy.emulator.desktop import DesktopDisplay
        ...
        if display_type == DISPLAY_TYPE__ST7789:
            ...
            if width == 240:
                ...
                from pillboy.hardware.displays.ST7789 import ST7789 as original_ST7789
                return original_ST7789(_width=width, _height=height)

            elif width == 320:
                from pillboy.hardware.displays.st7789_mpy import ST7789 as mpy_ST7789
            ...
            from pillboy.hardware.displays.ili9341 import ILI9341
